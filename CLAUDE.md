...
- **Chi phí chuyến:** bảng `trip_expenses` (VND số nguyên, `split_among uuid[]`), RLS theo `private.in_trip`; không có sửa, chỉ thêm/xoá. Chia tiền, ai trả ai tính ở client (`src/lib/expenses.js`).
