...
Đã chốt: màn hình Ghi lộ trình có "Tạm dừng" và "Mục tiêu hôm nay" (mặc định 5 km, chỉnh ở tab Tôi, lưu trên máy). Tab Chuyến đi gồm danh sách chuyến, chi tiết và phần chia sẻ; tab Tôi gồm giao diện sáng/tối, mục tiêu, vùng riêng tư, lộ trình đã lưu, nhập GPX, đăng xuất (cả hai chưa có mẫu thiết kế, dựng theo thành phần sẵn có). Ô "Tỉnh, thành" hiện "—" cho tới khi có dữ liệu ranh giới tỉnh.
