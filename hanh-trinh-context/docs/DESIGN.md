...
Đã chốt: màn hình Ghi lộ trình có "Tạm dừng" và "Mục tiêu hôm nay" (mặc định 5 km, chỉnh ở tab Tôi, lưu trên máy). Tab Chuyến đi gồm danh sách chuyến, chi tiết và phần chia sẻ; tab Tôi gồm hồ sơ và bạn bè, poster, thông báo "Ngày này năm trước", nhập Google Timeline, giao diện sáng/tối, mức xem mặc định của check-in, mục tiêu, vùng riêng tư, lộ trình đã lưu, nhập GPX, đăng xuất (cả hai chưa có mẫu thiết kế, dựng theo thành phần sẵn có). Ô "Tỉnh, thành" đếm theo 34 hoặc 63 tỉnh (chọn ở tab Tôi); số quốc gia hiện ở dòng dưới hàng thống kê. Scratch map tô tỉnh đã đến bằng `--accent` độ đục 0.28, không vẽ viền.
